...
const componentsDB = {
    ...
    ram: [
        {id:1, name:"Kingston Fury Beast 32GB (2x16) DDR5-6000", price:8990},
        {id:2, name:"Corsair Vengeance 32GB (2x16) DDR5-6400", price:10990},
        {id:3, name:"Kingston Fury Beast 64GB (2x32) DDR5-6000", price:18990},
        {id:4, name:"Corsair Vengeance RGB 32GB (2x16) DDR5-6000", price:11990},
        {id:5, name:"G.Skill Ripjaws S5 32GB (2x16) DDR5-6400", price:12490},
        {id:6, name:"Kingston Fury Beast 64GB (2x32) DDR5-6400", price:21990},
    ...
    ssd: [
        {id:1, name:"Samsung 990 EVO 1 ТБ NVMe", price:7990},
        {id:2, name:"Kingston NV2 1 ТБ NVMe", price:6990},
        ...
        {id:6, name:"Crucial T700 2 ТБ Gen5", price:22990},
    ],
    psu: [
        {id:1, name:"Deepcool PF750 750W 80+ Gold", price:8990},
        {id:2, name:"Corsair RM850x 850W 80+ Gold", price:11990},
        {id:3, name:"be quiet! Pure Power 12 M 850W", price:12490},
        {id:4, name:"Seasonic Focus GX-1000 1000W", price:17990},
        {id:5, name:"Corsair HX1200i 1200W 80+ Platinum", price:22990},
    ],
    case: [
        {id:1, name:"Deepcool CC560 ARGB", price:4990},
        {id:2, name:"Lian Li Lancool 216", price:9490},
        {id:3, name:"NZXT H6 Flow", price:12990},
        {id:4, name:"Fractal Design Meshify 2 Compact", price:15990},
    ...
    for (let cat in currentBuild) {
        ...
        html += `
            <div style="display:flex; justify-content:space-between; align-items:center; margin:6px 0;">
                <span>• ${item.name} — <b>${item.price.toLocaleString('ru-RU')} ₽</b></span>
                <button onclick="removeItem('${cat}')" style="background:#ff4444; color:white; border:none; padding:4px 10px; border-radius:8px; font-size:12px;">удалить</button>
            </div>`;
        total += item.price;
    }
...
function removeItem(category) {
    if (confirm(`Удалить ${currentBuild[category].name}?`)) {
