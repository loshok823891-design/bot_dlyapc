...
// здесь хранится всё, что выбрал пользователь в своей сборке
let currentBuild = {};

// ====================== большая база комплектующих ======================
// это список всех деталей, которые можно выбрать
const componentsDB = {
    cpu: [
        ...
        {id:9, name:"Intel Core i5-14600K", price:32990},
        {id:10, name:"Intel Core i7-14700K", price:44990},
        {id:11, name:"Intel Core i9-14900K", price:67990},
    ],
    motherboard: [
    ...
    gpu: [
        ...
        {id:2, name:"RTX 5070 12GB", price:67990},
        {id:3, name:"RTX 5070 Ti 16GB", price:89990},
        {id:4, name:"RX 7800 XT 16GB", price:58990},
    ],
    ssd: [
...
// ====================== ссылки на магазины ======================
// здесь лежат ссылки на разделы ozon и dns для каждой категории
const storeLinks = {
    cpu: { 
...
function showCategory(category) {
    ...
    // показываем кнопки перехода в ozon и dns
    ...
    // показываем карточки с комплектующими
...
// добавляем выбранное комплектующее в сборку
function addToBuild(category, name, price) {
    currentBuild[category] = {name, price};
    updateBuildSummary();
}

// обновляем список выбранных деталей
...
// при запуске показываем процессоры
window.onload = () => {
    showCategory('cpu');
};
