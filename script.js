...
const componentsDB = {
    cpu: [
        ...
        {id:4, name:"AMD Ryzen 9 9900X", price:58990},
        {id:5, name:"Intel Core i5-14600K", price:32990},
        {id:6, name:"Intel Core i7-14700K", price:44990},
        {id:7, name:"Intel Core i9-14900K", price:67990},
    ],
    gpu: [
        {id:1, name:"RTX 4060 8GB", price:32990},
        {id:2, name:"RTX 5070 12GB", price:67990},
        {id:3, name:"RTX 5070 Ti 16GB", price:89990},
        {id:4, name:"RTX 5080 16GB", price:129990},
        {id:5, name:"RX 7800 XT 16GB", price:58990},
        {id:6, name:"RX 9070 XT 16GB", price:74990},
    ],
    ram: [
...
function showCategory(category) {
    ...
    // показываем кнопки перехода в магазины
...
// обновляем информацию о текущей сборке
